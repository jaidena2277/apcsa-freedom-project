...
###  EDP(Engineering Design Process) and Skills
Currently, in the EDP(engineering design process), we are in the stages of one and two. We have tinkered but have not finished and will keep going back and forth with tinkering(defining) and adding more to our game(research). In terms of skills, I would say I have been using Debugging as we tinkered when our player wasnt working correctly and fixed the issue, Collaboration as we discussed in a discord call about how to fix things and make things, and How to google as finding the perfect assets was a difficult task since not many were nice enough or was not 3d.
